    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function moveSectionUp(){
            ...
            var index = $(SECTION_SEL).index($(SECTION_ACTIVE_SEL));
            var prev = index > 0 ? $(SECTION_SEL).eq(index - 1) : null;
            //looping to the bottom if there's no more sections above
            if ((!prev || !prev.length) && (options.loopTop || options.continuousVertical)) {
        ...
        */
        function moveSectionDown(){
            ...
            var index = $(SECTION_SEL).index($(SECTION_ACTIVE_SEL));
            var next = index >= 0 ? $(SECTION_SEL).eq(index + 1) : null;
