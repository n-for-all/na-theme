(function () {
  ...
  function _optionalChain$1(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }window["onYouTubeIframeCallbacks"] = [];
...
<div class="player">
  ...
  class YouTube {
  	...
  	__init() {this.video_id = "";}
  	
  	
  	
  	

  	constructor(video_id, slide) {YouTube.prototype.__init.call(this);YouTube.prototype.__init2.call(this);YouTube.prototype.__init3.call(this);YouTube.prototype.__init4.call(this);YouTube.prototype.__init5.call(this);YouTube.prototype.__init6.call(this);
  	...
  	__init2() {this.initialize = (callback) => {
  		if (this.player) {
              callback();
  			return;
  		}
  	...
  	__init3() {this.stop = () => {
  		_optionalChain$1([this, 'access', _7 => _7.player, 'optionalAccess', _8 => _8.stopVideo, 'call', _9 => _9()]);
  	};}

  	__init4() {this.pause = () => {
  		_optionalChain$1([this, 'access', _10 => _10.player, 'optionalAccess', _11 => _11.pauseVideo, 'call', _12 => _12()]);
  	};}
  	...
  	__init6() {this.onPlayerStateChange = (event) => {
  ...
  class NaSliderNavigation {
  	...
  	__init() {this.current = 0;}
  	__init2() {this.columns = 1;}
  	...
  	constructor(slider, pagination = 0, columns = 1, initial = 0, loop = false, infinite = false, onCreate = (index) => {}) {NaSliderNavigation.prototype.__init.call(this);NaSliderNavigation.prototype.__init2.call(this);
  		this.slider = slider;
  ...
  class NaSlider {
  	__init3() {this.inner = null;}
  	

  	__init4() {this.settings = null;}
  	__init5() {this.slide = {
  		height: 0,
  		width: 0,
  	};}
  	...
  	__init7() {this.columns = 1;}
  	__init8() {this.cInterval = null;}
  	__init9() {this.fade = false;}
  	__init10() {this.pause = false;}
  	__init11() {this.current = 0;}
  	__init12() {this.scroll = false;}
  	__init13() {this.slides = [];}
  	 ...
  	 __init14() {this._stop = false;}
  	 __init15() {this._fpsTime = 0;}
  	/**
  	 * __construct
  	 */
  	 constructor(selector, settings) {NaSlider.prototype.__init3.call(this);NaSlider.prototype.__init4.call(this);NaSlider.prototype.__init5.call(this);NaSlider.prototype.__init6.call(this);NaSlider.prototype.__init7.call(this);NaSlider.prototype.__init8.call(this);NaSlider.prototype.__init9.call(this);NaSlider.prototype.__init10.call(this);NaSlider.prototype.__init11.call(this);NaSlider.prototype.__init12.call(this);NaSlider.prototype.__init13.call(this);NaSlider.prototype.__init14.call(this);NaSlider.prototype.__init15.call(this);NaSlider.prototype.__init16.call(this);NaSlider.prototype.__init17.call(this);NaSlider.prototype.__init18.call(this);NaSlider.prototype.__init19.call(this);NaSlider.prototype.__init20.call(this);
  	...
  	__init16() {this.autoplay = (autoplay, delay = 3000) => {
  		let xf = () => {
  			setInterval(() => {
  				if (this._stop) {
  					return;
  	...
  	calculateDimensions() {
  		var height = 0;
  		let offsetHeader = _optionalChain([window, 'access', _2 => _2["naTheme"], 'optionalAccess', _3 => _3.headerOffset]) ? (_optionalChain([window, 'access', _4 => _4["naTheme"], 'optionalAccess', _5 => _5.headerOffset]) ? _optionalChain([window, 'access', _6 => _6["naTheme"], 'optionalAccess', _7 => _7.headerOffset]) : 0) : 0;
  	...
  	__init18() {this.getElement = () => {
  		return this.element;
  	};}

  	__init19() {this.getSlides = () => {
  		return this.slides;
  	};}
  		...
  		if (this.settings.sync && this.settings.sync != "") {
  			setTimeout(() => {
  				...
  				if (sync_slider) {
  					...
  					//@ts-ignore
  					this.element.addEventListener("active-slide", ((event) => {
  						let index = event.detail[0];
  						if (slider && slider.active() != index) slider.to(index);
  						return false;
  					}) );
  					//@ts-ignore
  					sync_slider.addEventListener("active-slide", ((event) => {
  						let index = event.detail[0];
  						if (this.navigation.getCurrent() != index) this.to(index);
  						return false;
  					}) );
  					//@ts-ignore
  					sync_slider.addEventListener("click-slide", ((event) => {
  						let index = event.detail[0];
  						if (this.navigation.getCurrent() != index) this.to(index);
  						return false;
  					}) );
  	...
  	onResizeElem(element, callback) {
  		...
  		onResizeElem["checkForChanges"] = function () {
  			...
  			data.offsetHeight || data.innerHeight;
  		...
  		if ("ResizeObserver" in window) {
  			...
  			this.resizeObserver = new ResizeObserver((entries) => {
  				for (const entry of entries) {
  					const width = _optionalChain([entry, 'access', _8 => _8.borderBoxSize, 'optionalAccess', _9 => _9[0], 'access', _10 => _10.inlineSize]);
