...
function api_authorize(redirect_uri) {
	...
	var url =
		'https://api.instagram.com/oauth/authorize/?client_id=' + key + '&redirect_uri=' + encodeURIComponent(redirect_uri) + '&response_type=' + type + '&scope=basic+public_content+follower_list';
