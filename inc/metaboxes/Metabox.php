...
{
    /**
     * Show the metabox, Please override this in your child class
    ...
    function _metabox_text($post_id, $_name, $group = '', $attributes = [])
    {
        ...
        if ($this->repeater) { ?>
            <input <?php echo $this->attributes($attributes, ['name', 'value']); ?> type="text" value="{{{data.<?php echo $_name; ?>}}}" name="<?php echo $name; ?>" />
        <?php } else { ?>
