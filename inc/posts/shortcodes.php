...
class Posts_Shortcode
{
    ...
    public function shortcode($atts)
    {
        ...
        $template = '<li class="post-list-item %s"><a data-id="%d" class="posts-image" style="%s" href="%s"><dt>%s</dt></a><div class="posts-header"><h3><a href="%s">%s</a></h3></div><div class="posts-content">%s</div></li>';
        if ($query->have_posts()) {
