<?php
class Events_Shortcode extends NA_METABOXES
{
    ...
    {
        ?>
        <script type="text/javascript">var events_ajax = "<?php echo admin_url('admin-ajax.php'); ?>"; </script>
    ...
    public function on_term_update($term, $taxonomy){
        ...
        <tr class="form-field term-slug-wrap">
			...
			<p class="description">The date from the taxonomy will manage, keep empty to use none</p></td>
		</tr>
        <tr class="form-field term-slug-wrap">
			...
			<p class="description">The date to the taxonomy will manage, keep empty to use none</p></td>
		</tr>
        <?php
    }
                ...
                while ($query->have_posts()) {
                    ...
                    switch($meta['type']){
                        case 'range':
                            ...
                            $dates = '<div class="events-range">'.$dates.'</div>';
                            break;
                        default:
		...
		<table class="form-table">
			<tbody>
				<tr class="form-field form-required term-name-wrap">
					...
					<p class="description">The events type.</p></td>
				</tr>
				<tr class="form-field form-required term-name-wrap">
