...
<script>
    jQuery(document).ready(function() {
        ...
        var toggle = null,
            toggle_title = null;
        var bounds = {
            top: logo.offset().top + logo.height() / 3,
            bottom: logo.offset().top + logo.height() - logo.height() / 3
        };
        var title_bounds = {
            top: title.offset().top + title.height() / 3,
            bottom: title.offset().top + title.height() - title.height() / 3
        };
